...
Defina construtores de tipo em C\dotfill\includegraphics[width=0.5\textwidth]{res/image25.png}\\ 
Operadores sobre bits no C\dotfill\includegraphics[width=0.2\textwidth]{res/image23.png}\\ 
Operadores de atribuição sobre bits no C\dotfill\includegraphics[width=0.3\textwidth]{res/image24.png}\\ 
...
Defina uma classe em C++\dotfill\includegraphics[width=0.5\textwidth]{res/image10.png}\\

\section*{Flash-Card 13 - C Como Programar} 
\section*{Flash-Card 13 - C Como Programar} 
\section*{Flash-Card 13 - C Como Programar} 
o que eu uso para usar operadores entre dois objetos\dotfill Sobrecarga de operadores\\ 
Um construtor pode retornar valores no C++\dotfill não\\ 
Qual o nome disto no C++, "::"\dotfill operador binário de resolução de escopo\\ 
Objeto imutável\dotfill const OBJ newOBJ;\\ 
Método imutável\dotfill method() const {};\\
O que "friend" faz\dotfill acesso especial a dados private e protected de uma classe\\
O que é a palavra reservada "this" no C++\dotfill ponteiro para o objeto atual\\ 
Três formas de acessar um atributo na classe\dotfill x,\ this->x,\ (*this).x\\
Sobrecarga de operadores\dotfill permite usar operadores com classes\\ 
Operadores que não podem ser sobrecarregados\dotfill \fbox{$::$,\ \texttt{.},\ \texttt{.*},\ ?:\ ,\ sizeof,\ typeid,\ casts}\\

\section*{Flash-Card 14 - C Como Programar} 
Oque eu uso para polimorfismo no C++\dotfill funcao virtual\\ 
operador de conversão pode ser chamado de\dotfill operador de cast\\ 
oque uma funcao virtual\dotfill função que pode ser sobrescrita nas classes filhas\\ 
